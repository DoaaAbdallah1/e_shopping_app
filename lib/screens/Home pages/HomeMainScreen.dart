// ignore_for_file: prefer_const_literals_to_create_immutables, prefer_const_constructors, file_names, prefer_adjacent_string_concatenation, prefer_interpolation_to_compose_strings, unused_local_variable, unnecessary_import, dead_code, unused_element
...
class _HomeMainScreenState extends State<HomeMainScreen> {
  ...
  Future getGridView() async {
    ...
    QuerySnapshot snap = await firestore.collection("products").get();
